# Spec: Esqueci Senha ViewModel

## Purpose

TBD — Definir os requisitos do `EsqueciSenhaViewModel`, responsável por encapsular toda a lógica de validação do campo email e envio do link de recuperação de senha via Firebase Auth, expondo resultados e estados para a `EsqueciSenhaScreen`.
