...
Defines the `UserModel` data class used throughout the application to represent a user entity. Handles serialization and deserialization with the Firebase Realtime Database.
